  ...
  <div class="shell">
    <aside class="aside">
      ...
      <nav class="nav" aria-label="Навигация">
        <a class="active" href="/course-admin/courses"><span>Курсы</span><span class="muted" style="font-size:12px;">CRUD</span></a>
        <a href="/course-admin/students"><span>Студенты</span><span class="muted" style="font-size:12px;">записи</span></a>
      </nav>
    </aside>
    <main class="main">
      <div class="top">
        ...
        <div class="actions">
          <a class="btn primary" href="/course-admin/courses/create">Создать курс</a>
        ...
        <div class="cardbody">
          ...
          ?>
            ...
            @foreach ($courses as $course)
                ...
                <td><div>{{ $course->start_date }}</div><div class="muted" style="font-size:12px;">—</div><div>{{ $course->end_date }}</div></td>
                <td>{{ $course->hours }}</td>
                <td>{{ $course->price }}</td>
                <td>
                  <div class="actions">
                    <a class="btn" href="lessons/{{ $course->id }}">Уроки</a>
                    <a class="btn" href="courses/{{ $course->id }}/edit">Редактировать</a>
