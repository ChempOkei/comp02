          ...
          @csrf
            ...
            <div class="grid">
              <div class="" id="startDateField">
                ...
                <input id="start_date" name="start_date" type="date" placeholder="дд-мм-гггг" required>
              ...
              <div class="" id="endDateField">
                ...
                <input id="end_date" name="end_date" type="date" placeholder="дд-мм-гггг" required>
                <div class="help">Обязательно, формат дд-мм-гггг</div>
            ...
            <div class="actions">
              ...
              <a class="btn" href="/course-admin/courses">Отмена</a>
            </div>
          </form>
        </div>
      </div>
