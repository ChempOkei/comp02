      ...
      <div class="body">
        ...
        @csrf
          ...
          <div class="" id="emailField">
            ...
            <input id="email" name="email" type="email" placeholder="admin@edu.com" class="@error('email') invalid @enderror" required>
            @error('email')
            <div class="err" id="emailError">Поле email обязательно</div>
            @enderror
          </div>
          <div class="" id="passwordField">
            <label for="password">Пароль</label>
            <input id="password" name="password" type="password" placeholder="••••••••" class="@error('password') invalid @enderror" required>
            @error('password')
            <div class="err" id="passwordError">Поле пароль обязательно</div>
            @enderror
          </div>
