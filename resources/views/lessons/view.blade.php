  ...
  <div class="shell">
    <aside class="aside">
      ...
      <nav class="nav" aria-label="Навигация">
        <a href="/course-admin/courses"><span>Курсы</span><span class="muted" style="font-size:12px;">CRUD</span></a>
        <a class="active" href="/course-admin/students"><span>Студенты</span><span class="muted" style="font-size:12px;">записи</span></a>
      </nav>
    </aside>
    <main class="main">
      <div class="top">
        ...
        <div class="actions">
          <a class="btn" href="/course-admin/courses">Назад</a>
          <a class="btn primary" href="/course-admin/lessons/create">Добавить урок</a>
          <a class="btn" href="/course-admin/login">Выйти</a>
        </div>
      </div>
        ...
        <div class="cardbody">
          ...
          ?>
            ...
            @foreach ($lessons as $lesson)
              <tr>
                <td>
                  <div style="font-weight:700;">{{ $lesson->name }}</div>
                  <div class="muted" style="font-size:12px;">{{ $lesson->description }}</div>
                </td>
                <td>1</td>
                <td><a href="#" style="color:#2563eb;text-decoration:none;">{{ $lesson->link }}</a></td>
                <td>
                  <div class="actions">
                    <a class="btn" href="/course-admin/lessons/{{ $lesson->id }}/edit">Редактировать</a>
            ...
            @endforeach
              <tr>
                ...
                <td>
                  <div class="actions">
                    <a class="btn" href="/course-admin/lessons/1/edit">Редактировать</a>
                    <a class="btn danger" href="#" data-confirm="Удалить урок?">Удалить</a>
                  </div>
                </td>
              </tr>
